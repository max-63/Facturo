...
var require_Chart = __commonJS({
  "node_modules/chartjs-plugin-style/node_modules/chart.js/dist/Chart.js"(exports, module) {
    (function(global, factory) {
      ...
      helpers$1.extend(DatasetController.prototype, {
        ...
        _configure: function() {
          var me = this;
          me._config = helpers$1.merge(/* @__PURE__ */ Object.create(null), [me.chart.options.datasets[me._type], me.getDataset()], {
        ...
        _resolveDatasetElementOptions: function(element, hover) {
          ...
          for (i = 0, ilen = elementOptions.length; i < ilen; ++i) {
            ...
            values[key] = resolve([custom[readKey], datasetOpts[readKey], options2[readKey]], context);
          }
          return values;
        },
        /**
        ...
        _resolveDataElementOptions: function(element, index) {
          ...
          if (helpers$1.isArray(elementOptions)) {
            for (i = 0, ilen = elementOptions.length; i < ilen; ++i) {
              key = elementOptions[i];
              values[key] = resolve([custom[key], datasetOpts[key], options2[key]], context, index, info);
            }
          } else {
            keys = Object.keys(elementOptions);
            for (i = 0, ilen = keys.length; i < ilen; ++i) {
              key = keys[i];
              values[key] = resolve([custom[key], datasetOpts[elementOptions[key]], datasetOpts[key], options2[key]], context, index, info);
            }
          }
          if (info.cacheable) {
...
var require_chartjs_plugin_style = __commonJS({
  "node_modules/chartjs-plugin-style/dist/chartjs-plugin-style.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_Chart()) : typeof define === "function" && define.amd ? define(["chart.js"], factory) : (global = global || self, global.ChartStyle = factory(global.Chart));
    })(exports, function(Chart) {
      "use strict";
      ...
      var styleHelpers = {
        ...
        getHoverColor: function(color) {
          return color !== void 0 ? helpers$1.getHoverColor(color) : color;
        },
      ...
      var StylePoint = Point.extend({
        draw: function(chartArea) {
          ...
          if (vm.skip || chartArea !== void 0 && !isPointInArea(vm, chartArea)) {
            return;
          }
          styleHelpers.drawShadow(chart, vm, drawCallback, true);
          if (styleHelpers.opaque(vm.backgroundColor)) {
      ...
      defaults.doughnut.legend.labels.generateLabels = defaults.pie.legend.labels.generateLabels = function(chart) {
        ...
        if (data.labels.length && data.datasets.length) {
          return data.labels.map(function(label, i) {
            ...
            var fill = resolve$1([custom.backgroundColor, ds.backgroundColor, arcOpts.backgroundColor], void 0, i);
            var stroke = resolve$1([custom.borderColor, ds.borderColor, arcOpts.borderColor], void 0, i);
            var bw = resolve$1([custom.borderWidth, ds.borderWidth, arcOpts.borderWidth], void 0, i);
            return extend$2({
              text: label,
              fillStyle: fill,
              strokeStyle: stroke,
      ...
      Chart.defaults.polarArea.legend.labels.generateLabels = function(chart) {
        ...
        if (data.labels.length && data.datasets.length) {
          return data.labels.map(function(label, i) {
            ...
            var custom = arc.custom || {};
            var arcOpts = chart.options.elements.arc;
            var fill = resolve$2([custom.backgroundColor, ds.backgroundColor, arcOpts.backgroundColor], void 0, i);
            var stroke = resolve$2([custom.borderColor, ds.borderColor, arcOpts.borderColor], void 0, i);
            var bw = resolve$2([custom.borderWidth, ds.borderWidth, arcOpts.borderWidth], void 0, i);
            return extend$4({
              text: label,
              fillStyle: fill,
              strokeStyle: stroke,
...
export default require_chartjs_plugin_style();
...
chartjs-plugin-style/dist/chartjs-plugin-style.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=chartjs-plugin-style.js.map
