...
@Component({
  selector: 'app-factures-brouillon',
  imports: [CommonModule, RouterModule, FormsModule, SidebarComponent],
  templateUrl: './factures-brouillon.component.html',
  styleUrl: './factures-brouillon.component.css'
})
export class FacturesBrouillonComponent {
