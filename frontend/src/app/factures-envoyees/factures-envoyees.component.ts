...
@Component({
  selector: 'app-factures-envoyees',
  imports: [CommonModule, RouterModule, FormsModule, SidebarComponent],
  templateUrl: './factures-envoyees.component.html',
  styleUrl: './factures-envoyees.component.css'
})
export class FacturesEnvoyeesComponent {
